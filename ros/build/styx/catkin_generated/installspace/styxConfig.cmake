...
if("FALSE" STREQUAL "TRUE")
  set(styx_SOURCE_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/src/styx)
  set(styx_DEVEL_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/devel)
  set(styx_INSTALL_PREFIX "")
  set(styx_PREFIX ${styx_DEVEL_PREFIX})
else()
  set(styx_SOURCE_PREFIX "")
  set(styx_DEVEL_PREFIX "")
  set(styx_INSTALL_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/install/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${styx_dep}_FOUND)
      find_package(${styx_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${styx_dep} REQUIRED ${depend_list})
  endif()
