...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_updater_SOURCE_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/src/waypoint_updater)
  set(waypoint_updater_DEVEL_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/devel)
  ...
  set(waypoint_updater_INSTALL_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/src/waypoint_updater/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${waypoint_updater_dep}_FOUND)
      find_package(${waypoint_updater_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${waypoint_updater_dep} REQUIRED ${depend_list})
  endif()
