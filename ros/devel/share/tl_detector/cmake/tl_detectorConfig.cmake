...
if("TRUE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rikki/repo/Self_Driving_Car/CarND-Capstone/ros/src/tl_detector/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tl_detector_dep}_FOUND)
      find_package(${tl_detector_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tl_detector_dep} REQUIRED ${depend_list})
  endif()
